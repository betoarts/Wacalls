...
export const useSessions = create<State>(() => ({ sessions: [], qrs: {}, activeId: null, loading: false }));

export const setActiveSession = (id: string): void => useSessions.setState({ activeId: id });

export const resetSessionsStore = (): void => useSessions.setState({ sessions: [], qrs: {}, activeId: null, loading: false });
