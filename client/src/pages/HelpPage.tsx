...
// Chave PIX (EMAIL) usada para apoiar o projeto.
const PIX_KEY = "humbertomoura.neto@gmail.com";
const PIX_MERCHANT_NAME = "HUMBERTO MOURA NETO";
...
const INSTAGRAM_HANDLE = "humberto.moura.neto";
const INSTAGRAM_URL = `https://www.instagram.com/${INSTAGRAM_HANDLE}/`;
const YOUTUBE_HANDLE = "#";
const YOUTUBE_URL = `https://www.youtube.com/@${YOUTUBE_HANDLE}`;
const SUPPORT_GROUP_URL = "https://chat.whatsapp.com/#";
...
const RESPONSIBLE_NAME = "Humberto da Silva Moura Neto";
      ...
      <div className="mx-auto max-w-3xl space-y-8 p-2 text-center">
        ...
        <Card>
          <CardHeader className="flex flex-col items-center gap-2 space-y-0 text-center">
            <SocialAvatar src={YOUTUBE_AVATAR_URL} alt={t("pages.help.youtubeTitle", { defaultValue: "Canal Humberto Neto" })} Icon={Youtube} />
            <div>
              <CardTitle className="text-lg">
                {t("pages.help.youtubeTitle", { defaultValue: "Canal Humberto Neto" })}
              </CardTitle>
              <CardDescription>
        ...
        <Card>
          <CardHeader className="flex flex-col items-center gap-2 space-y-0 text-center">
            ...
            <div>
              ...
              <CardDescription>
                {t("pages.help.instagramDesc", { defaultValue: "Acompanhe @humberto.moura.neto no Instagram." })}
              </CardDescription>
            </div>
          </CardHeader>
          <CardContent className="flex justify-center">
            <Button variant="outline" asChild>
              <a href={INSTAGRAM_URL} target="_blank" rel="noopener noreferrer">
                {t("pages.help.instagramButton", { defaultValue: "Seguir @humberto.moura.neto" })}
              </a>
            </Button>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardHeader className="flex flex-col items-center gap-2 space-y-0 text-center">
            ...
            <div>
              ...
              <CardDescription>
                {t("pages.help.pixDesc", { defaultValue: "Chave PIX (EMAIL) para contribuir com o desenvolvimento." })}
              </CardDescription>
            </div>
          </CardHeader>
