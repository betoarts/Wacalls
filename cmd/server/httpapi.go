...
func (s *server) routes() http.Handler {
	...
	// Estado da licenca: alimenta a faixa de aviso de vencimento no painel.
	mux.HandleFunc("GET /api/license", s.requireAuth(s.handleLicenseStatus))
	...
	s.registerQuickReplyRoutes(mux)
